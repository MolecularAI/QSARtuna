...
class InterfaceEnum:
    ...
    SKLEARN_SET = {
        ...
        _CE.ALGORITHMS_KNEIGHBORSCLASSIFIER,
        _CE.ALGORITHMS_KNEIGHBORSREGRESSOR,
    ...
    CHEMPROP_SET = {
        ...
        _CE.ALGORITHMS_CHEMPROP_REGRESSOR_PRETRAINED,
    }
    PRF_SET = {_CE.ALGORITHMS_PRF}
    CALIBRATED_SET = {
        _CE.ALGORITHMS_MAPIE_CLASSIFIER,
        _CE.ALGORITHMS_MAPIE_REGRESSOR,
