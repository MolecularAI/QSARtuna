...
@pytest.fixture
def file_pxc50(clean_shared_datadir):
    """Returns pxc50 dataset."""
    return str(clean_shared_datadir / "pxc50" / "P24863.csv")
...
def test_optsplitters_cli(clean_shared_datadir, filename, file_drd2_50, file_pxc50):
